...
export const CallToAction=()=>{
    return <section className="py-24 bg-[linear-gradient(to_top,#C2D3FF,white)] overflow-x-clip">
        <div className="container">
            ...
            <div className='relative'>
                <Image src={star} width={300} height={300} alt="star" className='absolute -top-[360px] -left-[210px]  rotate-[0deg] hidden md:block'/>
                <Image src={spring} width={300} height={300} alt="spring" className='absolute -top-[200px] -right-[200px]  rotate-[0deg] hidden md:block'/>
